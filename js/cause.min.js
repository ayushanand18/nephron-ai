...
function analyzecause(){
    ...
    $(".q24").fadeOut(300,function(){
        ...
        Based on the data you provided, we found that the top cause might be <br/>"+
        evaluated+"Other Causes like, <br/>\
        a drug that is toxic to the kidneys,rare genetic conditions, such as Alport syndrome, renal artery stenosis,\
        Henoch-Schönlein purpura, hemolytic uremic syndrome in children, Lupus nephritis is the medical name for kidney disease caused by lupus,\
        disorders in which the body’s immune system attacks its own cells and organs, such as Goodpasture syndrome, IgA glomerulonephritis	<br/>\
        might also be possible").delay(2000, function(){
            $(".recomendlink").show();
        });
    });
