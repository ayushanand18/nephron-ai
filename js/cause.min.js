...
function analyzecause(){
    ...
    $(".q24").fadeOut(300,function(){
        ...
        <a href='contact' class='report'>Report inappropriate results?</a><br/><br/>\
        <button class='recomendlink btn btn-success' style='border-radius:0px;padding-top:14px;padding-bottom:14px;'>Get a personal recommendation to follow.</button>");
