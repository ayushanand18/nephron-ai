...
var a = {0:"",1:"one",2:"two",3:"three",4:"four",5:"five",6:"six",7:"seven",8:"eight",9:"nine"}
var b = {"":0,"one":1,"two":2,"three":3,"four":4,"five":5,"six":6,"seven":7,"eight":8,"nine":9}
...
$(".qnine .finish").click(function(e){
    e.preventDefault();
    if ($("#htnt").val()==""){
        alert("Please enter a value")
    }
    else{
    qnine.fadeOut(300, function(){
        result.fadeIn(300);
    });
...
function prediction(){
    ...
    var locatn = 'unknown' ;
    var net_speed = navigator.connection.effectiveType;
    ...
    // Request starts
    var newurl="https://now-express.intru-innovation.vercel.app/clsazure"+"?sg="+sgt+"&al=" +alt+"&sc="+sct+"&hemo="+hemot+"&pcv="+pcvt+"&sod="+sodt+"&rc="+rct+"&dm="+dmt+"&htn="+htnt+"&brwsr="+brwsr+"&os="+"null"+"&locatn="+locatn+"&cpu="+cpu+"&ip="+ip;
    var xhttp = new XMLHttpRequest();
    var resdiv=$(".result");
    xhttp.onreadystatechange = function() {
     var causelink= document.querySelector(".causelink");
     if (this.readyState == 4 && this.status == 200) {
      if (this.responseText =="notckd"){
            $(".result").html("<br/>Congrats, You are SAFE! <br/> Based on the data you provided our AI Systems could <b>not find a possibility for Chronic Kidney Disease</b><br/><br/>\
            We are glad you are safe. Why not get some tips to stay safe forver?\
            <a class='btn btn-primary'  href='https://docs.google.com/viewer?url=https://ayushanand18.github.io/nephron-ai/assets/how-to-stay-safe.pdf'>Get Tips to Stay Safe</a> ");
        }
        else{
            ...
            if (alt == 0){
                resdiv.html("<br/>Congrats, You are SAFE! <br/> Based on the data you provided our AI Systems could <b>not find a possibility for Chronic Kidney Disease</b><br/><br/>\
                We are glad you are safe. Why not get some tips to stay safe forver?\
                <a class='btn btn-primary'  href='https://docs.google.com/viewer?url=https://ayushanand18.github.io/nephron-ai/assets/how-to-stay-safe.pdf'>Get Tips to Stay Safe</a> ");
            }
            else{
