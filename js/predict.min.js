...
function prediction(){
    ...
    var ip = 'unknown';
    // Request starts
    var newurl="https://now-express.intru-innovation.now.sh/clsazure"+"?sg="+sgt+"&al=" +alt+"&sc="+sct+"&hemo="+hemot+"&pcv="+pcvt+"&wc="+wct+"&rc="+rct+"&htn="+htnt;
    ...
    xhttp.onreadystatechange = function() {
     if (this.readyState == 4 && this.status == 200) {
      if (this.responseText.includes("notckd")){
            ...
            resdiv.html("<br/>You are in DANGER ! <br/> Based on the data you provided our AI Systems did figure out a <b>possibility of Chronic Kidney Disease</b>. Please go and see out a specialised physician!")
        }
        }
        }
