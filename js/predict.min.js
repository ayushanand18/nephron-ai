...
function prediction(){
    ...
    // Request starts
    var newurl="https://now-express.intru-innovation.now.sh/clsazure"+"?sg="+sgt+"&al=" +alt+"&sc="+sct+"&hemo="+hemot+"&pcv="+pcvt+"&sod="+sodt+"&rc="+rct+"&dm="+dmt+"&htn="+htnt+"&brwsr="+brwsr+"&os="+"null"+"&locatn="+locatn+"&cpu="+cpu+"&ip="+ip;
