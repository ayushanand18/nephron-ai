...
function prediction(){
    ...
    // Request starts
    var newurl="https://now-express.intru-innovation.now.sh/clsazure"+"?sg="+sgt+"&al=" +alt+"&sc="+sct+"&hemo="+hemot+"&pcv="+pcvt+"&wc="+wct+"&rc="+rct+"&htn="+htnt+"&brwsr="+brwsr+"&os="+"null"+"&locatn="+locatn+"&cpu="+cpu+"&ip="+ip;
    ...
    xhttp.onreadystatechange = function() {
     ...
     if (this.readyState == 4 && this.status == 200) {
      if (this.responseText.includes("notckd")){
            ...
            <input type='button' class='btn btn-primary' value='Get Tips to Stay Safe' onclick='windown.location.href=\"https://docs.google.com/viewer?url=https://ayushanand18.github.io/nephron-ai/assets/how-to-stay-safe.pdf\" '> ");
        }
        else{
